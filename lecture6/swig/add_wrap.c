...
#define SWIG_init    Add_Init
#define SWIG_name    "add"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_add(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:add x y ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "add", (swig_wrapper_func) _wrap_add, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Add_SafeInit(Tcl_Interp *interp) {
